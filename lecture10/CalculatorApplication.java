...
public class CalculatorApplication {
	...
	/*
	 * This function will prompt the user to enter his choice on exiting the
	 * program. If user chooses 'y' then program will exit. If user chooses 'n' then
	 * program will continue. If wrong input is given, then program will retry at
	 * max 5 times and after that it will exit forcefully
	 */
	...
	/*
	 * Take a character as input and decides which operation to perform. In case
	 * none of the operations match, it will prompt 'Unknown Operation'
	 */
